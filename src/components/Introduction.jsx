			...
			<section>
				<div className='intro-quote-div'>
					<h4 className='text-idea'>
						"I love creative problem solving, <br />building ambitious software, apps and websites"
						<br />
						<br />
				...
				<div className='parent-div-left'>
					...
					<div className='div-left'>
						...
						<p className='intro-text'>
							...
							<mark> Northcoders coding Bootcamp</mark> where I have gained the techniques and skills
							that have given me an extremely solid foundation for a career in software development. I have since built multiple web applications in React in a short amount of
							time and then moved onto mobile App with React Native. I'm excited to kickstart my
							developer career!
						</p>
					</div>
				</div>
				...
				<div className='parent-div-left-2'>
					...
					<div className='div-left-2'>
						...
						<p className='intro-text-2'>
							...
							<br />
							<br />
							As a stranger once said to me in a skatepark<br /> <mark>'you don't stop skating because you
							get old, you get old because you stop skating!'</mark><br /> Ever since, I've always remembered this and I try to apply to everything in life, especially learning new skills
							<br />
							<br />
